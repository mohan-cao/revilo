...
//            int[][] scheduleClone = new int[schedule.length][schedule[0].length];
//            for (int z = 0; z < schedule.length; z++) {
//            	for (int y = 0; y < schedule[0].length; y++) {
//            		scheduleClone[z][y] = schedule[z][y]; 
//                }
//            }
...
//    	for (int[] sub : currentSchedule) {
//    	    for (int subsub : sub) {
//    	        System.out.print(subsub + " ");
//    	    }
//    	    System.out.println();
//    	}
//    	for (boolean sub : unvisitedNodes){
//    		System.out.println(sub + " ");
//    	}
//    	System.out.println(currentCost);
//    	
//        int[][] bestschedule = currentSchedule;
...
//                    int[][] currentScheduleClone = new int[currentSchedule.length][currentSchedule[0].length]; 
//                    for (int z = 0; z < currentSchedule.length; z++) {
//                    	for (int y = 0; y < currentSchedule[0].length; y++) {
//                    		currentScheduleClone[z][y] = currentSchedule[z][y]; 
//                        }
//                    }
